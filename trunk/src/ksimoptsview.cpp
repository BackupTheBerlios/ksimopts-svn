...
ksimoptsView::~ksimoptsView()
{
}

void ksimoptsView::print(QPainter *p, int height, int width)
{
    // do the actual printing, here
    // p->drawText(etc..)
}

QString ksimoptsView::currentURL()
{
...
void ksimoptsView::openURL(const KURL& url)
{
    m_html->openURL(url);
}
...
void ksimoptsView::slotSetTitle(const QString& title)
{
    emit signalChangeCaption(title);
}
#include "ksimoptsview.moc"
